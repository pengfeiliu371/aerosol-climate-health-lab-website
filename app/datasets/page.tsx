...
const datasets: Dataset[] = [
  {
    ...
    description: (
      <>
        ...
        <p>The files provide monthly mean HCl and pCl emission fluxes in kg m<sup>âˆ’2</sup> s<sup>âˆ’1</sup>, gridded at 0.1Â° Ã— 0.1Â° resolution for 1960â€“2014. The data are HEMCO-ready and can be used directly in GEOS-Chem.</p>
      </>
    ),
    access: [
      {
  ...
  },
  {
    ...
    description: (
      <>
        <p>We developed a method to measure the spectroscopic complex refractive indices (<em>m</em> = <em>n</em> + <em>ik</em>) of secondary organic aerosol (SOA) thin films using ellipsometry and UVâ€“VIS spectrophotometry. The method was applied to SOA from the ozonolysis of Î±-pinene, limonene, and catechol, and from the photooxidation of toluene and <em>m</em>-xylene. Squalane and nigrosin measurements provide method validation.</p>
    ...
    references: [
      ...
      {
        label: "Liu, P. F., Abdelmalki, N., Hung, H.-M., et al. (2015). Ultraviolet and visible complex refractive indices of secondary organic material produced by photooxidation of the aromatic compounds toluene and m-xylene. Atmospheric Chemistry and Physics, 15, 1435â€“1446.",
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <p>The repository contains tabulated diffusivity data for sucrose and SOA materials derived from Î±-pinene, toluene, and <em>m</em>-xylene.</p>
      </>
    ),
    access: [
      {
    ...
    references: [
      {
        label: "Liu, P., Li, Y. J., Wang, Y., et al. (2018). Highly viscous states affect the browning of atmospheric organic particulate matter. ACS Central Science, 4, 207â€“215.",
  ...
  },
  {
    ...
    title: "Reconstructed black-carbon emissions, 1750â€“2010",
    ...
    description: (
      <>
        <p>We reconstructed two gridded global biomass-burning emission datasets from 1750 to 2010 using inverse analysis, with 31 ice-core black-carbon records as observational constraints and GEOS-Chem simulations of emissionâ€“deposition sensitivity.</p>
        <p>BB4CMIP<sub>post</sub>, based on the <a href="https://doi.org/10.5194/gmd-10-3329-2017" target="_blank" rel="noreferrer">BB4CMIP prior inventory</a>, is provided on a 0.25Â° Ã— 0.25Â° grid. LPJ-LMfire<sub>post</sub>, based on the <a href="https://doi.org/10.1126/sciadv.abc1379" target="_blank" rel="noreferrer">LPJ-LMfire prior inventory</a>, is provided on a 0.5Â° Ã— 0.5Â° grid. Black-carbon emissions are public and model-ready; CH<sub>4</sub>, CO, H<sub>2</sub>, N<sub>2</sub>O, NH<sub>3</sub>, NMVOCs, NO<sub>x</sub>, OC, and SO<sub>2</sub> emissions are available upon request.</p>
      </>
    ),
    access: [
      {
          ...
          {datasets.map((dataset, index) => (
            <article key={dataset.title}>
              ...
              <figure className="dataset-figure">
                <img src={dataset.image} alt={dataset.alt} />
              </figure>
            </article>
          ))}
        </section>
